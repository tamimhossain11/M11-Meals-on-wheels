...
public class MealsOnWheelsBackEndApplication {
	...
	CommandLineRunner initRunner(CustomerRepository customerRepository, PasswordEncoder passwordEncoder,
		...
		return args -> {
			...
			partner.setName("Tamim Hossain");
			partner.setAddress("Dhaka, Bangladesh");
			partner.setEmail("Tamim@gmail.com");
			partner.setActive(true);
			partner.setPassword(passwordEncoder.encode("169831"));
			...
			member.setName("Sewwandi");
			member.setAddress("matara,srilanka");
			member.setGender(EGender.MALE);
			member.setRole(ERole.ROLE_MEMBER);
			member.setEmail("sewwandi@gmail.com");
			member.setActive(true);
			member.setPassword(passwordEncoder.encode("169831"));
			...
			rider.setName("aarvi");
			rider.setAddress("diyathalawa,Sri-lanka");
			rider.setGender(EGender.MALE);
			rider.setRole(ERole.ROLE_RIDER);
			rider.setEmail("aarvi@gmail.com");
			rider.setActive(true);
			rider.setPassword(passwordEncoder.encode("169831"));
			...
			volunteer.setName("chathu");
			volunteer.setAddress("kandy,Sri-lanka");
			volunteer.setGender(EGender.MALE);
			volunteer.setRole(ERole.ROLE_VOLUNTEER);
			volunteer.setEmail("chathu@gmail.com");
