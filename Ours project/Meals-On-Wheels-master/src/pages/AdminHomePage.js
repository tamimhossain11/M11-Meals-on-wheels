    ...
    <Layout>
      <Container>
        ...
        <div className="pb-5">
          <div size={12} md={9}>
            <div className="task pb-5">
              <h4 className="fw-bold title-caregiver">Provide  partner a task</h4>
        ...
        <div>
          <Col size={12} md={12} >
            <div className="task pb-5">
              <h4 className="fw-bold title-caregiver">Deploy/Assign a Rider</h4>
              <div className="card">
                <div className="container">
                  <div className="task-header-div">
                    <Table
